...
public partial class HiveParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IHiveParserVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitEmpty([NotNull] HiveParser.EmptyContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitFunction([NotNull] HiveParser.FunctionContext context) { return VisitChildren(context); }
	/// <summary>
